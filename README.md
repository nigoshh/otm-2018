...
- **HUOM jotta voisit osallistua viikolla 6 pidettävään koodikatselmointiin (josta tarjolla 2 kurssipistettä), tulee viikon 5 deadlinen jälkeen palautusrepositoriosta löytyä sellainen toimiva versio harjoitustyöstä, joka toteuttaa mielekkään osan määrittelydokumentissa listatusta toiminnallisuudesta**
