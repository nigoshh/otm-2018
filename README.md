...
- Viikon 5 harjoitustyön [tavoitteet](https://github.com/mluukkai/otm-2018/blob/master/tehtavat/harjoitustyo_viikko5.md), deadline tiistaina 22.4. klo 23:59
  - **Jotta voisit osallistua viikolla 6 pidettävään koodikatselmointiin (josta tarjolla 2 kurssipistettä), tulee viikon 5 deadlinen jälkeen palautusrepositoriosta löytyä sellainen toimiva versio harjoitustyöstä, joka toteuttaa mielekkään osan määrittelydokumentissa listatusta toiminnallisuudesta**
