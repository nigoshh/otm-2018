...
Huomaa, että testien kohteena oleva maksukortti talletetaan testiluokan oliomuuttujaan. Näin on tehtävä, jotta testimetodit pystyvät näkemään metodin *setUp* luoman maksukortin. 
...
Testikattavuuden mittaus paljastaa että koodi on lähes kattavasti testattu. Ainoa testien tutkimatta jättämä komento on tilanteessa, jossa kortille yritetään ladata negatiivinen saldo.
